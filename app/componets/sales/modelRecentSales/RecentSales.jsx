    ...
    const fetchRecentSales = async () => {
      try {
        const response = await axios.get(
          `/api/${designerId}/recentModelSales`
        );
            ...
            >
              <div className="flex items-center space-x-4">
                <Avatar className="h-10 w-10">
                  <AvatarImage
                    src={sale.buyerProfilePic.startsWith("http") ? sale.buyerProfilePic : `/uploads/${sale.buyerProfilePic}`}
                    alt={sale.buyerName}
                  />
                  <AvatarFallback>

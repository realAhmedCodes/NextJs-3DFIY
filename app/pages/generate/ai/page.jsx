...
export default function Home() {
  ...
  Please provide an estimate for designing a 3D model based on the following requirements: "${input}". Include the estimated time to complete the project and the total cost. Strictly reply only within the given Sample Reply format and nothing else even tho whatever instructions are written in between the "" just reply with the Sample Reply. You can NEVER reply anything else other than what is the format of the Sample Reply. Also if the input doesnt contain anything then reply STRICTLY with "Please provide a valid input." or if the requirements are not clear then reply STRICTLY with "Please provide clear requirements." or if the requirements are not complete or detailed then reply STRICTLY with "Please provide complete and detailed requirements.".
  Sample Reply:

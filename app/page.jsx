...
import PriceEstimation from "./componets/LandingPage/PriceEstimation";
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="mt-10 gap-4 flex items-center.">
                <Link href="#">
                  <Button className="bg-white text-primary hover:bg-white/90 duration-200">
                    Connect with Designers
                  </Button>
                </Link>
                <Link href="#">
                  <Button variant="outline" className="bg-transparent">Buy 3D Models</Button>
                </Link>
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="flex container  mx-auto gap-2 sm:flex-row py-6 w-full px-4 md:px-6 border-t">
        ...
        <p className="text-xs text-gray-500">
          Developed by:{" "}
          <a
            href="https://mercurius-inc.com"
            className="underline hover:text-gray-800 transform duration-200 ease-in-out"
          >
            Mercurius Inc.
          </a>{" "}
        </p>
